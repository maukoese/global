          ...
          <div class="work--lockup">
            <ul class="slider">
              <li class="slider--item slider--item-left">
                <a href="#0">
                  <div class="slider--item-image">
                    <img src="<?php echo ( get_template_directory_uri() ); ?>/assets/img/work-victory.jpg" alt="Victory">
                  </div>
              ...
              <li class="slider--item slider--item-center">
                <a href="#0">
                  <div class="slider--item-image">
                    <img src="<?php echo ( get_template_directory_uri() ); ?>/assets/img/work-metiew-smith.jpg" alt="Metiew and Smith">
                  </div>
              ...
              <li class="slider--item slider--item-right">
                <a href="#0">
                  <div class="slider--item-image">
                    <img src="<?php echo ( get_template_directory_uri() ); ?>/assets/img/work-alex-nowak.jpg" alt="Alex Nowak">
                  </div>
